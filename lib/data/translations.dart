...
class AppLocales extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'basedOnReview': 'Based on @count reviews',
          'noReviews': 'No Reviews',
          'seeReviews': 'See Reviews',
          'suggestionProducts': 'Suggestion Products',
          ...
          'saveFavPlaces': 'Save your favourite places',
          'clickToPick': 'Click here to pick your @type address',
          'title': 'Title',
          ...
          'placeOrderAgree':
              'By placing your order, you agree to our privacy policy and terms  & conditions.',
          ...
          'emptyFav': 'There is no favourite yet',
          'addNow': 'Add Now',
          'removeAllFav': 'Remove All Favourite',
          'removeFavDesc': 'Are you sure you want to remove all?',
          'remove': 'Remove',
          //Orders
          'emptyOrder': 'There is no orders yet',
          'ongoingOrder': 'Ongoing Order',
          'receivedOrder': 'Received Order',
          'orderNo': 'Order # @num',
          'estimatedDeliDate': "Estimated Delivery Day",
          'tax': 'Tax @percent %',
        ...
        'my_MM': {
          ...
          'emptyFav': 'ကြိုက်နှစ်သက်သော ပစ္စည်းမရှိသေးပါ',
          'addNow': 'ပစ္စည်းထည့်မည်',
          'removeAllFav': 'ကြိုက်နှစ်သက်သောပစ္စည်းများကိုဖျက်မည်',
          'removeFavDesc': 'အကုန်လုံးဖျက်မှာ သေချာပါသလား',
          'remove': 'ဖျက်မည်',
          //Orders
