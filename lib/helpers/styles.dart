...
class Styles {
  ...
  static TextStyle l1 =
      const TextStyle(color: Color.fromRGBO(0, 0, 0, 0.5), fontSize: 18);

  static TextStyle l2 =
      const TextStyle(color: Color.fromRGBO(0, 0, 0, 0.5), fontSize: 17);
  static TextStyle l3 =
      const TextStyle(color: Color.fromRGBO(0, 0, 0, 0.5), fontSize: 16);
  static TextStyle l4 =
      const TextStyle(color: Color.fromRGBO(0, 0, 0, 0.5), fontSize: 15);
  static TextStyle l5 =
      const TextStyle(color: Color.fromRGBO(0, 0, 0, 0.5), fontSize: 14);
  static TextStyle l6 =
      const TextStyle(color: Color.fromRGBO(0, 0, 0, 0.5), fontSize: 13);
